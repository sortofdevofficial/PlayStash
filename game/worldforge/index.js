...
import {
  ...
  serializeWorld, RESOURCE_KEY_BY_SHORT, BUILD_CODE, TYPE_BY_CODE, listOtherWorlds
} from "./db.js";
...
document.getElementById("viewWorldsBtn").onclick = async () => {
...
document.getElementById("closeOtherWorldsBtn").onclick = () => {
